...
exports.run = async (client, message) => {
    ...
    let embed = {
        ...
        description: `
Running commit: **#${runningNumber+1} [${runningCommit[0]}](https://github.com/zneix/zneixbot/commit/${runningCommit[0]})${(runningCommit[0]==lastCommit)?' [Latest]':''}** \`${msToHuman(message.createdAt - parseInt(runningCommit[1])*1000)} ago\`
Commands loaded: **${client.commands.size}**
Developer: **${client.users.get('288028423031357441').tag}**
OS: ${process.platform}
